...
//====================================================================================
  ...
  child: SizedBox.fromSize(
    ...
    child: Image.network('https://cdn.shopify.com/s/files/1/0605/9026/0388/products/9a0ea9f20d71c3a3c5c3cde16671be5d_4abb9bab-fd05-4051-a57e-9f9f5703552e.jpg?v=1654816454',
     fit: BoxFit.cover)  , ),
      )      ),
...
//==============================================================================================
  Positioned(
        ...
        child: 
      Container(
        child: Text("Haier DC Inverter", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 16, color: Colors.black87),),
      )),
...
//====================================================================================
    ...
    Positioned(
        ...
        child: 
      Container(
        child: Text("Rs. 80,000", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 22, color: Colors.green),),
      )),
   ...
   child: Column( crossAxisAlignment: CrossAxisAlignment.end,
     children: [
      SizedBox(height: _h*0.403),
        Text("Rs 80,000",textAlign:TextAlign.left ,style: TextStyle(fontWeight: FontWeight.w300, fontSize: 18, color: Colors.black54),),
        ...
        SizedBox(height: _h*0.05),
        Text("Rs 80,400", textAlign:TextAlign.left, style: TextStyle(fontWeight: FontWeight.normal, fontSize: 20, color: Colors.black),),
