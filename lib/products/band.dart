...
import 'package:appUp_one/checkout/band_order.dart';
...
//===============================================================================================
   ...
   top: -90,
            child: Container(
              height: _h * 0.60,
              width: _w * 0.99,
              child: Image.network("https://www.wareable.com/media/imager/202011/35179-original.jpg",),
            ),
          ),
 //===============================================================================================
      Positioned(
        ...
        child: 
      Container(
        child: Text("Rs. 5,500", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 32, color: Colors.green ),),
      )),
//===============================================================================================
      Positioned(
        top: 275,
...
//===============================================================================================
        ...
        child: 
      Container(
        child: Text("Mi Band-5", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 18, color: Colors.black87 ),),
      )),
//===============================================================================================
        Positioned(
        top: 330,
...
Positioned(
      ...
      Container(
        height: 52,
         child: ElevatedButton(
                  onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Band_Order()));},
