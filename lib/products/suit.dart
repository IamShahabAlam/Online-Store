...
import 'package:appUp_one/checkout/suit_order.dart';
...
//===============================================================================================
   ...
   top: -20,
            child: Container(
              height: _h * 0.60,
              width: _w * 0.99,
              child: Image.network("https://image.made-in-china.com/202f0j00aocfdbgKEkqv/Ready-to-Ship-Latest-Design-Groom-Wedding-Pictures-Men-s-Coat-Pant-Designs-Wedding-Suit-Made-in-China.jpg"),
            ),
          ),
 //===============================================================================================
      Positioned(
        ...
        child: 
      Container(
        child: Text("Rs. 8,500", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 32, color: Colors.green ),),
      )),
//===============================================================================================
      Positioned(
        top: 275,
...
//===============================================================================================
        ...
        child: 
      Container(
        child: Text("Suit Men", style: TextStyle(fontWeight: FontWeight.normal, fontSize: 18, color: Colors.black87 ),),
      )),
//===============================================================================================
        Positioned(
        top: 330,
...
Positioned(
      ...
      Container(
         child: ElevatedButton(
                  onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Fash()));},
...
Positioned(
      ...
      Container(
        height: 52,
         child: ElevatedButton(
                  onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => Suit_Order()));},
